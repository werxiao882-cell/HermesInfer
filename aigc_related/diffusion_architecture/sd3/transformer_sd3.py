...
from diffusers.models.attention_processor import Attention, FusedJointAttnProcessor2_0, JointAttnProcessor2_0
...
class SD3Transformer2DModel(ModelMixin, AttentionMixin, ConfigMixin):
    """
