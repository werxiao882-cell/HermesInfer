...
# Add the local trl directory to the path to avoid import conflicts
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), "trl"))
...
if __name__ == "__main__":
    ...
    # Check if running in a debugger or without arguments
